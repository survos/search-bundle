...
namespace Survos\SearchBundle\Maker;
...
class MakeSearch extends AbstractMaker
{
    ...
    public function generate(InputInterface $input, ConsoleStyle $io, Generator $generator): int
    {
        ...
        $io->text([
            ...
            'Find the documentation at <fg=yellow>https://github.com/survos/search-bundle/blob/main/docs/ux-search/usage/customize-your-search.md</>',
        ]);
