                ...
                {% if (page - 1) >= 1 %}
                    <li class="ux-search-pagination__item">
                        <a
                            ...
                            rel="prev"
                        >
                            <span class="ux-search-sr-only">{{ 'pagination.previous_page'|trans(domain='survos_search') }}</span>
                ...
                {% if page < totalPage %}
                    <li class="ux-search-pagination__item">
                        <a
                            ...
                            rel="next"
                        >
                            <span class="ux-search-sr-only">{{ 'pagination.next_page'|trans(domain='survos_search') }}</span>
